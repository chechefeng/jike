    ...
    render() {
        return (
            <section className="section _logo-list -border">
                <div className="container"><a href="https://customers.twilio.com/1445/twitch" className="logo-link"><span
                ...
                </a><a href="https://customers.twilio.com/199/zendesk" className="logo-link"><span className="_text">Launched in 40 new countries</span>
                ...
                </a><a href="https://customers.twilio.com/222/nordstrom-reinvents-personal-shopping-with-twilio-mms/"
                       className="logo-link"><span className="_text">Increased global sales</span>
                ...
                </a><a href="https://customers.twilio.com/249/lyft" className="logo-link"><span className="_text">Worldwide support deployed in days</span>
