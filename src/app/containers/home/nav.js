            ...
            <nav className="nav">
                <div className="nav-body"><a  className="nav-logo">Twilio</a>
                    <ul className="nav-menu">
                        <li className="nav-menu__item"><a >Products</a>
                                    ...
                                    <li className="nav-menu__dropdown-body">
                                        <ul className="nav-menu__dropdown-body__list nav-menu__dropdown-body__list--products">
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__title">Twilio Flex
                                                </div>
                                            ...
                                            <li><a  className="nav-menu__dropdown-body__list-item">
                                                <aside
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.2" height="13.1"
                                                         viewBox="0 0 15.2 13.1">

                                                    </svg>
                                                </aside>
                                                <div className="nav-menu__dropdown-body__list-item__title">Programmable
                                                    SMS
                                                </div>
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                <aside
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="16.8" height="16.1"
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                <aside
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="15.1" height="11.8"
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Embed
                                                    live
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                <aside
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.17 23.82">
                                                        <title>icon-nav--product-authy</title>

                                                    </svg>
                                                </aside>
                                                <div className="nav-menu__dropdown-body__list-item__title">Authy</div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Login
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__title">Twilio API
                                                    for
                                                    WhatsApp
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Connect
                                                    IoT
                        ...
                        <li className="nav-menu__item"><a >Solutions</a>
                            <div className="nav-menu__dropdown">
                                <ul className="nav-menu__dropdown-wrapper">
                                    <li className="nav-menu__dropdown-header">
                                        ...
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__title">Introducing
                                                    the
                                                    Engagement Cloud
                                                </div>
                                    ...
                                    <li className="nav-menu__dropdown-body">
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Create
                                                    a
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Protect
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Reach,
                                                    convert, and retain users through the right channels
                                                </div>
                                            </a></li>
                                            <li><a
                                                   className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">Collaboration
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Build
                                                    apps
                        ...
                        <li className="nav-menu__item"><a >Docs &amp; Tools</a>
                            <div className="nav-menu__dropdown">
                                <ul className="nav-menu__dropdown-wrapper">
                                    <li className="nav-menu__dropdown-body">
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a  className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">API Reference
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Full
                                                    endpoint documentation for all products
                                                </div>
                                            </a></li>
                                            <li><a
                                                   className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">Quickstarts
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Get to
                                        ...
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">API Status
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Live
                                                    uptime monitoring of the API and all services
                                                </div>
                                            </a></li>
                                            <li><a  className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">Blog</div>
                                                <div className="nav-menu__dropdown-body__list-item__description">
                                                    Community projects and Twilio updates
                                                </div>
                                            </a></li>
                                            <li><a className="nav-menu__dropdown-body__list-item">
                                                <div className="nav-menu__dropdown-body__list-item__title">TwilioQuest
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">Learn
                        ...
                        <li className="nav-menu__item"><a >Customer Stories</a>
                            <div className="nav-menu__dropdown">
                                <ul className="nav-menu__dropdown-wrapper">
                                    <li className="nav-menu__dropdown-body">
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a className="nav-menu__dropdown-body__list-item"
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__title">Technology
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">
                                            ...
                                            <li><a  className="nav-menu__dropdown-body__list-item"
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">
                                                    <b>Airbnb</b>, <b>Lyft</b>, and <b>Instacart</b> build the on-demand
                                                    economy
                                                </div>
                                            </a></li>
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item" title="Security">
                                                <div className="nav-menu__dropdown-body__list-item__title">Retail</div>
                                                <div className="nav-menu__dropdown-body__list-item__description"><b>Nordstrom</b>
                                                    and <b>eBay</b> engage with shoppers
                                                </div>
                                            </a></li>
                                            <li><a className="nav-menu__dropdown-body__list-item" title="Security">
                                                <div className="nav-menu__dropdown-body__list-item__title">Healthcare
                                                </div>
                                            ...
                                            <li><a className="nav-menu__dropdown-body__list-item" title="Security">
                                                <div className="nav-menu__dropdown-body__list-item__title">Real Estate
                                                </div>
                                                <div className="nav-menu__dropdown-body__list-item__description">
                                                    <b>Trulia</b> and <b>Apartment List</b> help clients find a perfect
                                                    home
                                                </div>
                                            </a></li>
                        ...
                        <li className="nav-menu__item"><a >Partners</a>
                            <div className="nav-menu__dropdown">
                                <ul className="nav-menu__dropdown-wrapper">
                                    <li className="nav-menu__dropdown-body">
                                        <ul className="nav-menu__dropdown-body__list">
                                            <li><a
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">Browse
                                                    and
                                            ...
                                            <li><a
                                                ...
                                                <div className="nav-menu__dropdown-body__list-item__description">We’re
                                                    here
                        ...
                        <li className="nav-menu__item"><a >Pricing</a></li>
                    </ul>
                        ...
                        <div className="nav-mobile__wrapper">
                            <ul className="nav-menu__dropdown-body__list nav-menu__dropdown-body__list--products">
                                <li data-order="0"><a className="nav-menu__dropdown-body__list-item">
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__description">The cloud contact
                                        center platform
                                    </div>
                                </a></li>
                                <li data-order="0"><a className="nav-menu__dropdown-body__list-item">
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__title">Programmable SMS</div>
                                    <div className="nav-menu__dropdown-body__list-item__description">Send &amp; receive
                                        text
                                        messages
                                    </div>
                                </a></li>
                                <li data-order="0"><a className="nav-menu__dropdown-body__list-item">
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__title">Programmable Voice</div>
                                ...
                                <li data-order="0 1 2 3"><a
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__title">Programmable Video</div>
                                ...
                                <li data-order="0 1 2 4"><a
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__title">Authy</div>
                                    <div className="nav-menu__dropdown-body__list-item__description">Login security for
                                ...
                                <li data-order="0 1 2"><a
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__description">Instantly provision
                                ...
                                <li data-order="0 1 2 3 4 5"><a
                                    ...
                                    <div className="nav-menu__dropdown-body__list-item__description">Connect IoT devices
                                        to
                                        global cellular networks
                                    </div>
                                </a></li>
                                <li><a  className="nav-menu__dropdown-body__list-link">See all
                                    products</a>
                                </li>
                            </ul>
