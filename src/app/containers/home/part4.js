        ...
        return (
            <section className="section two-column _demo -stacked -border">
                <div className="container">
                        ...
                        <div className="demo demo--expired" role="demo" data-step="1">
                            ...
                            <div className="demo__container"><span className="demo__notification"><header>Notice: session expired</header><p>To generate a new keyword, please refresh this page.</p></span>
                                <div className="demo__description">
                                    <header>
                                        <div className="demo__links"><a href="#prev" role="step" data-prev="">Prev</a><a
                                            href="#next" role="step" data-next="">Next</a></div>
                                    ...
                                    <div className="demo__instructions"><p>Let's write your first Twilio code.</p><p>Use
                                        ...
                                        reply which says "<a href="/docs/glossary/what-is-ahoy" target="_blank">Ahoy,
                                            world!</a>"</p><p>Awesome! Now let’s learn how to reply to messages.</p><p>
                                        Next: <a href="#next" role="step" data-next="">Introduction to TwiML</a></p>
                                    </div>
                                    <div className="demo__instructions"><p>The code <span className="two-col-visible">to the left</span><span
                                        ...
                                        target="_blank">TwiML</a>, the Twilio Markup Language. You use TwiML to tell
                                        Twilio how to respond to incoming text messages and phone calls.</p><p>The <a
                                        href="/docs/api/twiml/sms/message" target="_blank">&lt;Message&gt; TwiML
                                        ...
                                        you’ll see your new reply.</p><p>Next: <a href="#next" role="step" data-next="">TwiML
                                        templating</a></p></div>
                                    <div className="demo__instructions"><p>When your app gets a text, Twilio asks your
                                        app
                                        how to respond and <a href="/docs/api/twiml/sms/twilio_request" target="_blank">includes
                                        ...
                                        conversations with your users.</p><p>Next: <a href="#next" role="step"
                                                                                      data-next="">Beyond TwiML</a></p>
                                    </div>
                                    <div className="demo__instructions"><p>Congrats! You now know the basics of using
                                        ...
                                        send outbound messages anytime you want using our <a href="/docs/sms">HTTP API
                                            or our SDK for your programming language</a>.</p><p><a href="/try-twilio">Sign
                                        up for your free Twilio account</a> and you’ll have your own Twilio number.
                                        Next, <a href="/quest">play through TwilioQuest</a> to unlock the secrets of
                    ...
                    <div className="section-padding-top text-center"><a className="button -red -big" href="/try-twilio">
                        Start building
